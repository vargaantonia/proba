...
public partial class IngatlanberlesiplatformContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Foglalasok>(entity =>
        {
            ...
            entity.Property(e => e.FoglalasId).HasColumnType("int(11)").HasColumnName("foglalas_id");
            entity.Property(e => e.Allapot).HasDefaultValueSql("'''függőben'''")
                .HasColumnType("enum('függőben','elfogadva','elutasítva')").HasColumnName("allapot");
            entity.Property(e => e.BefejezesDatum).HasColumnType("date").HasColumnName("befejezes_datum");
            entity.Property(e => e.BerloId).HasColumnType("int(11)").HasColumnName("berlo_id");
            entity.Property(e => e.IngatlanId).HasColumnType("int(11)").HasColumnName("ingatlan_id");
            entity.Property(e => e.KezdesDatum).HasColumnType("date").HasColumnName("kezdes_datum");
            entity.Property(e => e.LetrehozasDatum).HasDefaultValueSql("'current_timestamp()'")
                .HasColumnType("timestamp").HasColumnName("letrehozas_datum");
        ...
        modelBuilder.Entity<Ingatlankepek>(entity =>
        {
            ...
            entity.Property(e => e.KepId).HasColumnType("int(11)").HasColumnName("kep_id");
            entity.Property(e => e.FeltoltesDatum).HasDefaultValueSql("'current_timestamp()'")
                .HasColumnType("timestamp").HasColumnName("feltoltes_datum");
            entity.Property(e => e.IngatlanId).HasColumnType("int(11)").HasColumnName("ingatlan_id");
            entity.Property(e => e.KepUrl).HasColumnType("text").HasColumnName("kep_url");
        ...
        modelBuilder.Entity<Ingatlanok>(entity =>
        {
            ...
            entity.Property(e => e.IngatlanId).HasColumnType("int(11)").HasColumnName("ingatlan_id");
            entity.Property(e => e.Ar).HasPrecision(10).HasColumnName("ar");
            entity.Property(e => e.Cim).HasMaxLength(255).HasColumnName("cim");
            entity.Property(e => e.FeltoltesDatum).HasDefaultValueSql("'current_timestamp()'")
                .HasColumnType("timestamp").HasColumnName("feltoltes_datum");
            entity.Property(e => e.Helyszin).HasMaxLength(255).HasDefaultValueSql("'NULL'").HasColumnName("helyszin");
            entity.Property(e => e.Leiras).HasDefaultValueSql("'NULL'").HasColumnType("text").HasColumnName("leiras");
            entity.Property(e => e.Meret).HasDefaultValueSql("'NULL'").HasColumnType("int(11)").HasColumnName("meret");
            entity.Property(e => e.Szoba).HasColumnType("int(10)").HasColumnName("szoba");
            entity.Property(e => e.Szolgaltatasok).HasDefaultValueSql("'NULL'")
                .HasColumnType("text").HasColumnName("szolgaltatasok");
            entity.Property(e => e.TulajdonosId).HasColumnType("int(11)").HasColumnName("tulajdonos_id");
        ...
        modelBuilder.Entity<Jogosultsagok>(entity =>
        {
            ...
            entity.Property(e => e.JogosultsagId).HasColumnType("int(11)").HasColumnName("jogosultsag_id");
            entity.Property(e => e.JogosultsagNev).HasMaxLength(100).HasColumnName("jogosultsag_nev");
            entity.Property(e => e.Leiras).HasDefaultValueSql("'NULL'").HasColumnType("text").HasColumnName("leiras");
        });
        ...
        modelBuilder.Entity<Szerepkorok>(entity =>
        {
            ...
            entity.Property(e => e.SzerepkorId).HasColumnType("int(11)").HasColumnName("szerepkor_id");
            entity.Property(e => e.SzerepkorNev).HasMaxLength(50).HasColumnName("szerepkor_nev");
        });
        ...
        modelBuilder.Entity<Telepulesek>(entity =>
        {
            ...
            entity.Property(e => e.Nev).HasMaxLength(20).HasColumnName("nev");
            entity.Property(e => e.Kep).HasDefaultValueSql("'NULL'").HasColumnType("text").HasColumnName("kep");
            entity.Property(e => e.Leiras).HasMaxLength(300).HasDefaultValueSql("'NULL'").HasColumnName("leiras");
            entity.Property(e => e.Megye).HasMaxLength(25).HasColumnName("megye");
        });
